	...
	function hizzle_recaptcha_show_environment_notice(){
		?>
			<div class="notice notice-error is-dismissible">
				<p>
					<strong>
						<?php echo __( 'Your version of PHP is below the minimum version of PHP required by "reCAPTCHA by Hizzle". Please contact your host and request that your version be upgraded to 5.6.0 or greater.', 'hizzle-recaptcha' ); ?>
					</strong>
				</p>
			</div>
		<?php
